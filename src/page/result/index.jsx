        ...
        <Row justify="center">
          <Col span={8} offset={-1}>
            <div style={{ textAlign: 'center' }}>
              <h2>Winner</h2>
              <h1>{winner.name}</h1>
              <div><Image alt="Winner" src={winner.avatar_url} preview={false} className={styles.imagecss} /></div>
              <div>
                Repos:
                {' '}
                {winner.public_repos}
          ...
          <Col span={8} offset={1}>
            <div style={{ textAlign: 'center' }}>
              <h2>Loser</h2>
              <h1>{loser.name}</h1>
              <div><Image alt="Loser" src={loser.avatar_url} preview={false} className={styles.imagecss} /></div>
              <div>
                Repos:
                {' '}
                {loser.public_repos}
